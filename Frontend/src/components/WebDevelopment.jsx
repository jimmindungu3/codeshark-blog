  ...
  return (
    <div className="p-2 md:p-6 mx-auto bg-white dark:bg-gray-800">
      ...
      <ul className="mb-6 text-sm md:text-base list-disc ml-6 md:ml-8 text-gray-800 dark:text-gray-300">
        <li>
          HTML5: Semantic markup, multimedia elements, and form validation
        </li>
        <li>
          CSS3: Flexbox, Grid, animations, and responsive design principles
        </li>
        <li>
          JavaScript: DOM manipulation, event handling, and modern ES6+ features
        </li>
      ...
      <ul className="mb-6 text-sm md:text-base list-disc ml-6 md:ml-8 text-gray-800 dark:text-gray-300">
        <li>
          Servers: HTTP servers, application servers, and deployment
          environments
        </li>
      ...
      <ul className="mb-6 text-sm md:text-base list-disc ml-6 md:ml-8 text-gray-800 dark:text-gray-300">
        <li>
          Version Control: Git workflows, collaboration, and code management
        </li>
        <li>Build Tools: Webpack, Babel, and task runners</li>
        <li>
          Testing: Unit testing, integration testing, and test-driven
          development
        </li>
      ...
      <ul className="mb-6 text-sm md:text-base list-disc ml-6 md:ml-8 text-gray-800 dark:text-gray-300">
        <li>
          Input Validation: Sanitizing user input and preventing injection
          attacks
        </li>
        <li>HTTPS: Secure data transmission and SSL/TLS certificates</li>
        <li>CORS: Managing cross-origin resource sharing</li>
        <li>
          Security Headers: Implementation of security headers and best
          practices
        </li>
      </ul>
      ...
      <p className="mb-6 text-sm md:text-base text-gray-800 dark:text-gray-300">
        Web development continues to evolve with new technologies and
        approaches:
      </p>
      <ul className="mb-6 text-sm md:text-base list-disc ml-6 md:ml-8 text-gray-800 dark:text-gray-300">
